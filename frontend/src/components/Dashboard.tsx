...
export default function Dashboard({ onViewProfile, onGoHome, onLogout }: DashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-black selection:text-white flex flex-col md:flex-row relative">
      ...
      {/* MODERN LEFT SIDEBAR */}
      <aside className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-zinc-200 flex flex-col justify-between shrink-0 md:h-screen md:sticky md:top-0 z-40">
        ...
        <div className="p-6 border-t border-zinc-200/80 space-y-2">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header className="sticky top-0 z-30 bg-white/85 backdrop-blur-md border-b border-zinc-200 px-6 py-4 flex items-center justify-between gap-4">
          
          <div className="flex items-center gap-2 text-xs font-bold text-zinc-500">
            <span className="text-zinc-400">Dashboard</span>
            <CaretRight className="h-3 w-3 text-zinc-300" />
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-sm bg-black px-4 py-1.5 text-xs font-bold text-white hover:bg-zinc-900 transition-all hover:scale-105 active:scale-95 shadow-md cursor-pointer"
            >
