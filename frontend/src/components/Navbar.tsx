    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/50 bg-white/70 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-brand-indigo to-brand-pink text-white font-bold shadow-md shadow-indigo-200">
            e
          </div>
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="#profile" className="text-sm font-medium text-slate-600 hover:text-brand-indigo transition-colors">
            Profile Preview
          </a>
